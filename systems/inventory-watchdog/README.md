...
A configurable system that prevents stockouts, reduces overstocks, and tracks fulfillment across multiple channels — drawn from a real deployment at a multi-channel consumer products company monitoring ~900 SKUs across 15 warehouse locations with <2 hours/week of ops manager time.
...
## Representative Numbers (Illustrative Reference Deployment)

> Figures below are illustrative of a representative deployment, anonymized — not audited results. See `docs/DEPLOYMENT-EXAMPLE.md` for the full walkthrough.

**Profile:** Multi-channel consumer products company (4 product lines, ~900 SKUs, 15 warehouse locations, 3 sales channels: DTC + Amazon + Wholesale)
...
**Modeled metrics (6-month horizon):**
...
🟠 14–20 Days — ATTENTION (5)
  #8472 | Customer A | 16d | $127.00
  #8501 | Customer B | 18d | $215.00 [Rx]
  #8529 | Customer C | 19d | $89.00

🔶 21–29 Days — WARNING (4)
  #8201 | Customer D | 23d | $342.00 ⚠️ non-Rx
  #8215 | Customer E | 27d | $156.00

🔴 30–60 Days — CRITICAL (3)
  #7890 | Customer F | 38d | $512.00 ⚠️ REFUND RISK
  #7921 | Customer G | 42d | $234.00 [Rx]
  #7956 | Customer H | 45d | $178.00 ⚠️ non-Rx
...
• All orders contain SKU-1005 (Line A, Blue)
...
A: No problem. Use product line filtering (monitor only active/profitable SKUs) or segment by velocity tier (A/B/C classification). The reference deployment tracks ~900 SKUs with no performance issues.
...
Reference deployment: multi-channel consumer products company (anonymized) — see `docs/DEPLOYMENT-EXAMPLE.md`  
Extraction date: April 2026  
Version: 1.1

---

**Ready to deploy?** Start with `config/intake-v1.md` to map your business context, then review `examples/dtc-eyewear-netsuite.json` for a representative configuration.
