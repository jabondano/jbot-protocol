...
A configurable system that automates sales pipeline visibility and follow-up management, proven in production at a multi-channel consumer products company monitoring 80+ active B2B deals across a seven-figure pipeline with <3 hours/week of sales director time.
...
## Representative Numbers (Reference Implementation)

**Company:** Consumer hardware manufacturer (DTC + B2B wholesale, multiple product lines), anonymized. Figures are illustrative of the reference deployment, not audited results.
...
├── examples/
│   ├── wholesale-b2b-hubspot.json (B2B wholesale pipeline, anonymized)
...
└── docs/
    ...
    └── DEPLOYMENT-EXAMPLE.md (anonymized reference deployment)
```
...
Reference implementation developed at a multi-channel consumer products company over 8 weeks (early 2026), anonymized.
