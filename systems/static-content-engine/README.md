...
A configurable system that automates creative asset production at scale, used by a multi-brand consumer products company to produce 40-80 assets/month with <6 hours/week of creative director time.
...
│   └── DEPLOYMENT-EXAMPLE.md (real implementation, anonymized)
├── config/
...
Built as part of the JBOT Protocol.

Reference implementation developed at a multi-brand consumer products company over 10 weeks. See `docs/DEPLOYMENT-EXAMPLE.md` (anonymized).
